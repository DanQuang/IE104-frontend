    ...
    <div className="profile-container">
      <div className="profile-header">
        ...
        <div className="profile-info">
          ...
          <p className="tier">
            Tier hiện tại: <span>{user.tier?.current_tier || "Cơ bản"}</span>
          </p>
        </div>
      </div>
        ...
        <div className="detail-item">
          ...
          <ul>
            ...
            <li>
              ...
              {user.credit_account?.account_name || "Chưa có thông tin"}
            </li>
            <li>
              <strong>Số tài khoản:</strong>{" "}
              {user.credit_account?.account_number || "Chưa có thông tin"}
            </li>
          </ul>
        </div>
      </div>
